...
public class TableCellHeadingTagTest {

    @Test
    public void headingTagsShouldRenderLargerText() throws IOException {
        float margin = 40f;
        ...
        Row<PDPage> row = table.createRow(140f);
        row.createCell(30, "Heading");
        ...
        String html = "<table>"
            ...
            + "</td></tr>"
            + "</table>";
        row.createTableCell(70, html, doc, page, yStart, margin, bottomMargin);
        ...
        File file = new File("target/TableCellHeadingTagTest.pdf");
        ...
        assertTrue(normalizedText.contains("Plain text"));
